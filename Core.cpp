...
void Core::decode() {
	...
	bool terminate_inst = if_of->terminate->Read();
	...
	of_ex->terminate->Write(terminate_inst);
...
void Core::execute() {
	...
	bool terminate_inst = of_ex->terminate->Read();
	...
	ex_ma->terminate->Write(terminate_inst);
...
void Core::mem_access() {
	...
	bool terminate_inst = ex_ma->terminate->Read();
	...
	ma_rw->terminate->Write(terminate_inst);
}
//writes the results back to register file
void Core::write_back() {
	cout<<endl<<"!--------- WRITE BACK ---------!"<<endl<<endl;

	bool terminate_inst = ma_rw->terminate->Read();
